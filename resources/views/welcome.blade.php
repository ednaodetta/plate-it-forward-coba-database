                ...
                <div class="flex flex-col justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 text-lg mt-4 leading-relaxed">
                            Every individual has the power to create a kinder world through small, meaningful actions.
                            It
                            begins
    ...
    <div class="bg-DefaultWhite rounded-lg shadow-md overflow-hidden mx-auto max-w-6.7xl mt-40">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="flex flex-col w-full md:w-3/5">
                <!-- Map Image -->
                <div class="relative">
                    <img src="{{ asset('assets/Image/map.jpg') }}" alt="World Map with Marker" class="w-full h-auto">
                </div>
    ...
    <div class="bg-DefaultWhite py-10">
        <div class="carousel-container max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8 mt-14">
                ...
                <p class="text-gray-600 text-2xl font-brandon">See how Plate It Forward and your support have helped
                    those in need!</p>
            </div>
